 ...
 *
 * @author wangsibo
 * @date 2023-04-09 11:44:26
 */
public class ConvertBstToGreaterTree_538 {

    private static Solution getSolution() {
        return new ConvertBstToGreaterTree_538().new Solution();
    }
    ...
    public static void main(String[] args) {
        ...
        TreeNode node = Builder.buildTreeNode(4, 1, 6, 0, 2, 5, 7, null, null, null, 3, null, null, null, 8);
        TreeNode treeNode = solution.convertBST(node);
